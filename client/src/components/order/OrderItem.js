...
const OrderItem = props => {
  ...
  return (
    <li className="flex bg-white-50 items-center lh-copy pa3 ph0-l bb bw2 b--black-10">
      <div className="pl3 flex-auto">
        <span className="f5 f4-ns db black-70">Name: {props.order.name}</span>
        <span className="f5 f4-ns db black-70">
          Contact: {props.order.contactNumber}
        </span>
        <span className="f5 f4-ns db black-70">Email: {props.order.email}</span>
        <span className="f5 f4-ns db black-70">Items: {items}</span>
        <span className="f5 f4-ns db black-70">Bill: {bill}</span>
        <span className="f5 f4-ns db black-70">
          Status:{' '}
          {props.order.status ? (
